...
#define CONFIG_EXAMPLES_AUDIO_RECORDER 1
#define CONFIG_EXAMPLES_AUDIO_RECORDER_PROGNAME "audio_recorder"
#define CONFIG_EXAMPLES_AUDIO_RECORDER_PRIORITY 100
#define CONFIG_EXAMPLES_AUDIO_RECORDER_STACKSIZE 2048
